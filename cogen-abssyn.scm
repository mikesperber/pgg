...
(define (annMakeOp op args)
  (vector 'OP #f #f 0 op args #t #f))
(define (annMakeOpaqueOp op args)
  (vector 'OP #f #f 0 op args #f #f))
(define (annMakeFullOp op opaque property args)
  (vector 'OP #f #f 0 op args opaque property))
(define (annMakeOp1 opaque property)
  (lambda (op args) (annMakeFullOp op opaque property args)))
(define (annIsOp? e)

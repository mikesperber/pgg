...
(writelpp *generating-extension* "examples/app-c0.scm")
...
(writelpp *generating-extension* "examples/app-rc0.scm")
;;; load generating extension
...
(writelpp *generating-extension* "examples/ctors-c0.scm")
...
(writelpp *generating-extension* "examples/lambda-c0.scm")
...
(writelpp *generating-extension* "examples/cps-lr-c0.scm")
...
;(writelpp *generating-extension* "examples/direct-lr-pgg-c0.scm")
...
(writelpp *generating-extension* "examples/scheme1-pgg-c0.scm")

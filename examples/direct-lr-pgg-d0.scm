  ...
  (_let 1
        ...
        (lambda (xs_2)
          (_let 1
                acc_1
                (lambda (acc_1)
                  (multi-memo 1 'loop_1-1357 '(1 1) (list xs_2 acc_1)))))))
(define (loop_1-1357 xs_2 acc_1)
  (_if 1
                  ...
                  (_let 2
                        ...
                        (lambda (xxx-1329)
                          (multi-memo 2
                                      'loop_4-1353
                                      '(2 2 1)
                                      (list xxx-1329 ch_2 la-set_1)))))))))
(define (loop_4-1353 xxx-1329 ch_2 la-set_1)
  (_if 2
       xxx-1329
       (lambda ()
         xxx-1329)
       (lambda ()
         (multi-memo 1 'loop_4-1354 '(2 1) (list ch_2 la-set_1)))))
(define (loop_4-1354 ch_2 la-set_1)
  (_if 1
  ...
  (_if 2
       ...
       (lambda ()
         (inner-loop_1 ch_2
                       ...
                       input_3
                       (_op 1 'cdr trie_2)))))
(define (inner-loop_1-1352 pos_1 k_2 input_3)
  (_if 1
                                       ...
                                       (lambda (attribute-value_1)
                                         (multi-memo 1
                                                     ...
                                                     (list grammar_1
                                                           ...
                                                           attribute-value_1
                                                           input_1)))))))))))))
(define (continue_1-1347 grammar_1
                         k_1
                         first-map_1
                         closure_1
                         attribute-stack_1
                                                                                ...
                                                                                (lambda (result_2)
                                                                                  (multi-memo 1
                                                                                              ...
                                                                                              (list next-state_1
                                                                                                    ...
                                                                                                    closure_2
                                                                                                    attribute-stack_2)))))))))))))))))))))))
(define (parse-bar-1339 next-state_1
                        result_2
                        grammar_2
                        k_3
                        first-map_2
                                               ...
                                               (lambda (nts_1)
                                                 (multi-memo 1
                                                             ...
                                                             (list the-dot_1
                                                                   ...
                                                                   the-inp_1
                                                                   nts_1)))))))))))))))
(define (parse-bar-1340 the-dot_1
                        the-lhs_1
                        grammar_2
                        k_3
                        first-map_2
       ...
       (lambda ()
         (multi-memo 2
                     ...
                     (list the-dot_1
                           ...
                           the-inp_1
                           nts_1)))))
(define (parse-bar-1341 the-dot_1
                        the-lhs_1
                        grammar_2
                        k_3
                        first-map_2
                                                ...
                                                (lambda (input_1)
                                                  (multi-memo 1
                                                              ...
                                                              (list state_1
                                                                    ...
                                                                    k_1
                                                                    input_1)))))))))))))))
(define (direct-parse-1335 state_1
                           grammar_1
                           first-map_1
                           attribute-stack_1
                           k_1
  ...
  (_if 1
       ...
       (lambda ()
         (select-lookahead-item_1 ts_2
                                  ...
                                  k_1
                                  input_1))))
(define (direct-parse-1337 state_1 grammar_1 ts_1)
  (_if 1
       (_op 1 'final? state_1 grammar_1)
       (lambda ()
       ...
       (lambda ()
         ts_1)))
(define (direct-parse-1336 attribute-stack_1 input_1)
  (_if 2
       (_op 2
            'equal?
            (_lift 1 1 (_lift0 1 '$))
...
(define (filter-20-1333 pred?_2 rest_1 result_1)
  (_if 1
       (_op 1 'null? rest_1)
       (lambda ()
       ...
       (lambda ()
         (filter-20 pred?_2
                    ...
                    (multi-memo 1
                                ...
                                '(1 1 1)
                                (list pred?_2 rest_1 result_1))))))
(define (filter-20-1334 pred?_2 rest_1 result_1)
  (_if 1
...
(define (my-list->list l_1)
  (_let 1
        l_1
        (lambda (l_1)
          (multi-memo 1 'my-list->list-1332 '(1) (list l_1)))))
(define (my-list->list-1332 l_1)
  (_if 1
          ...
          (_let 2
                ...
                (lambda (stack_2)
                  (multi-memo 1
                              ...
                              '(1 2)
                              (list n_1 stack_2)))))))
(define (top->mylist-1330 n_1 stack_2)
  (_if 1
       (_op 1 'zero? n_1)
       (lambda ()
         (_ctor_memo 1 '() 'mynil))
       (lambda ()
         (multi-memo 1 'top->mylist-1331 '(1 2) (list n_1 stack_2)))))
(define (top->mylist-1331 n_1 stack_2)
  (_if 1
